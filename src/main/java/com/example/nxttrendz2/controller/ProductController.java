...
public class ProductController {
    ...
    public Product getProductById(@PathVariaable("productId") int productId) {
    ...
    public Product updateProduct(@PathVariable("productId") int productId, @RequestBody Product){
